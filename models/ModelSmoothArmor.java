...
public static class ModelSmoothArmor extends ModelBase {
	...
	public ModelSmoothArmor() {
		...
		left_arm.cubeList.add(new ModelBox(left_arm, 0, 32, -1.0F, -2.0F, -2.0F, 4, 12, 4, 0.0F, false));
		...
		left_leg.cubeList.add(new ModelBox(left_leg, 17, 32, -2.0F, 0.0F, -2.0F, 4, 12, 4, 0.0F, false));
