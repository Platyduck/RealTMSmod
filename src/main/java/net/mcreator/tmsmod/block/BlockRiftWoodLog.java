...
public class BlockRiftWoodLog extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:rift_wood_log")
	public static final Block block = null;
	public BlockRiftWoodLog(ElementsTmsModMod instance) {
		super(instance, 358);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rift_wood_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:rift_wood_log", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("rift_wood_log");
