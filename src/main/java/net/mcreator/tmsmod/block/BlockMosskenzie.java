...
import net.mcreator.tmsmod.procedure.ProcedureTheBeetleDrop;
...
public class BlockMosskenzie extends ElementsTmsModMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:mosskenzie", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setUnlocalizedName("mosskenzie");
			setRegistryName("mosskenzie");
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(Items.PUMPKIN_SEEDS, (int) (1)));
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureTheBeetleDrop.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
