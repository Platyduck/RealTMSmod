...
public class BlockButterflyGemOre extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:butterfly_gem_ore")
	public static final Block block = null;
	public BlockButterflyGemOre(ElementsTmsModMod instance) {
		super(instance, 216);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("butterfly_gem_ore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("tms_mod:butterfly_gem_ore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("butterfly_gem_ore");
