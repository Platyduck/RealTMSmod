...
public class BlockWhiteRose extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:white_rose")
	public static final Block block = null;
	public BlockWhiteRose(ElementsTmsModMod instance) {
		super(instance, 498);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:white_rose", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("white_rose");
			setRegistryName("white_rose");
		}
