...
public class BlockOvergrownSlab extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:overgrown_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("tms_mod:overgrown_slab_double")
	public static final Block block_slab_double = null;
	public BlockOvergrownSlab(ElementsTmsModMod instance) {
		super(instance, 349);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("overgrown_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("overgrown_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:overgrown_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("overgrown_slab");
