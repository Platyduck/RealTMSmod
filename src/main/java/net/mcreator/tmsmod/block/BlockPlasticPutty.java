...
public class BlockPlasticPutty extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("plastic_putty"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:plastic_putty", "inventory"));
	}
	...
	public static class BlockCustom extends BlockFalling {
		public BlockCustom() {
			...
			setUnlocalizedName("plastic_putty");
