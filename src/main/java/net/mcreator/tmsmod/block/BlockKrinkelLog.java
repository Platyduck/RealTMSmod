...
public class BlockKrinkelLog extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:krinkel_log")
	public static final Block block = null;
	public BlockKrinkelLog(ElementsTmsModMod instance) {
		super(instance, 23);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("krinkel_log"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:krinkel_log", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("krinkel_log");
