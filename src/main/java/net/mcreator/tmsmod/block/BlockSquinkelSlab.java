...
public class BlockSquinkelSlab extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:squinkel_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("tms_mod:squinkel_slab_double")
	public static final Block block_slab_double = null;
	public BlockSquinkelSlab(ElementsTmsModMod instance) {
		super(instance, 34);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("squinkel_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("squinkel_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:squinkel_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("squinkel_slab");
