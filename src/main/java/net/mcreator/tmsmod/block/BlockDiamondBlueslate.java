...
public class BlockDiamondBlueslate extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:diamond_blueslate")
	public static final Block block = null;
	public BlockDiamondBlueslate(ElementsTmsModMod instance) {
		super(instance, 323);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("diamond_blueslate"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("tms_mod:diamond_blueslate", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("diamond_blueslate");
