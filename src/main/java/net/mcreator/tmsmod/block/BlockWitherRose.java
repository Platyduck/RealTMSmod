...
public class BlockWitherRose extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:wither_rose")
	public static final Block block = null;
	public BlockWitherRose(ElementsTmsModMod instance) {
		super(instance, 276);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:wither_rose", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("wither_rose");
