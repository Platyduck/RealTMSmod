...
public class BlockLemonBush extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:lemon_bush")
	public static final Block block = null;
	public BlockLemonBush(ElementsTmsModMod instance) {
		super(instance, 36);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:lemon_bush", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("lemon_bush");
			setRegistryName("lemon_bush");
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemLemon.block, (int) (2)));
		}
