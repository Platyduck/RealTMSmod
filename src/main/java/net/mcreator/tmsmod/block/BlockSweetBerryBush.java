...
import net.mcreator.tmsmod.item.ItemSweetBerries;
...
public class BlockSweetBerryBush extends ElementsTmsModMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("tms_mod:sweet_berry_bush", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemSweetBerries.block, (int) (3)));
		}
