...
public class BlockRose extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:rose")
	public static final Block block = null;
	public BlockRose(ElementsTmsModMod instance) {
		super(instance, 524);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:rose", "inventory"));
	}
