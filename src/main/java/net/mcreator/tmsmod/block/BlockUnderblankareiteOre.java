...
public class BlockUnderblankareiteOre extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:underblankareite_ore")
	public static final Block block = null;
	public BlockUnderblankareiteOre(ElementsTmsModMod instance) {
		super(instance, 198);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("underblankareite_ore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("tms_mod:underblankareite_ore", "inventory"));
	}

	@Override
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		boolean dimensionCriteria = false;
		if (dimID == WorldUnderblankarianZone.DIMID)
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("underblankareite_ore");
