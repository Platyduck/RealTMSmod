...
public class BlockRiftWoodSlab extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:rift_wood_slab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("rift_wood_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("rift_wood_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:rift_wood_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("rift_wood_slab");
			setSoundType(SoundType.WOOD);
			setHardness(2.4F);
			setResistance(3.5999999999999996F);
			setLightLevel(0F);
			setLightOpacity(255);
