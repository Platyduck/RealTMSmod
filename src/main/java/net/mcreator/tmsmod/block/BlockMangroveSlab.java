...
public class BlockMangroveSlab extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:mangrove_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("tms_mod:mangrove_slab_double")
	public static final Block block_slab_double = null;
	public BlockMangroveSlab(ElementsTmsModMod instance) {
		super(instance, 330);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("mangrove_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("mangrove_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:mangrove_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("mangrove_slab");
