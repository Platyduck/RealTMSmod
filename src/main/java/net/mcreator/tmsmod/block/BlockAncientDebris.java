...
public class BlockAncientDebris extends ElementsTmsModMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:ancient_debris", "inventory"));
	}
