...
public class BlockKrinkelSlab extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:krinkel_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("tms_mod:krinkel_slab_double")
	public static final Block block_slab_double = null;
	public BlockKrinkelSlab(ElementsTmsModMod instance) {
		super(instance, 27);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("krinkel_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("krinkel_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("tms_mod:krinkel_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("krinkel_slab");
