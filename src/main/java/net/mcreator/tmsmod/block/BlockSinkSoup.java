...
public class BlockSinkSoup extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:sink_soup")
	...
	public void initElements() {
		...
		}.setUnlocalizedName("sink_soup").setRegistryName("sink_soup"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName("sink_soup"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomMeshDefinition(item, new ItemMeshDefinition() {
			...
			public ModelResourceLocation getModelLocation(ItemStack stack) {
				return new ModelResourceLocation("tms_mod:sink_soup", "sink_soup");
			}
		});
