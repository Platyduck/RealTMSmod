...
import net.mcreator.tmsmod.item.ItemAbbyCloud;
...
public class WorldAbbyCloud extends ElementsTmsModMod.ModElement {
	public static int DIMID = 22;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("tms_mod:abby_cloud_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemAbbyCloud().setUnlocalizedName("abby_cloud").setRegistryName("abby_cloud"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension abby_cloud is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("abby_cloud", "_abby_cloud", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemAbbyCloud.block, 0, new ModelResourceLocation("tms_mod:abby_cloud", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("abby_cloud_portal");
			setRegistryName("abby_cloud_portal");
			setLightLevel(0F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockCrubstone.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:abby_fields")),};
