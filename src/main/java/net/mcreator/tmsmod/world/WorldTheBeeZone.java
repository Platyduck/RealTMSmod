...
package net.mcreator.tmsmod.world;
...
import net.mcreator.tmsmod.item.ItemTheBeeZone;
import net.mcreator.tmsmod.block.BlockHoneyFluid;
import net.mcreator.tmsmod.block.BlockBeesWax;
import net.mcreator.tmsmod.block.BlockBeehiveWall;
...
public class WorldTheBeeZone extends ElementsTmsModMod.ModElement {
	public static int DIMID = 12;
	public static final boolean NETHER_TYPE = true;
	@GameRegistry.ObjectHolder("tms_mod:the_bee_zone_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldTheBeeZone(ElementsTmsModMod instance) {
		super(instance, 74);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemTheBeeZone().setUnlocalizedName("the_bee_zone").setRegistryName("the_bee_zone"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension the_bee_zone is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("the_bee_zone", "_the_bee_zone", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemTheBeeZone.block, 0, new ModelResourceLocation("tms_mod:the_bee_zone", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.8, 0.63137254902, 0);
		}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? BlockBeehiveWall.block.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockBeehiveWall.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("the_bee_zone_portal");
			setRegistryName("the_bee_zone_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockBeehiveWall.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockBeehiveWall.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockBeehiveWall.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != BlockBeehiveWall.block
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockBeesWax.block.getDefaultState();
		private static final IBlockState STONE2 = BlockBeesWax.block.getDefaultState();
		private static final IBlockState STONE3 = BlockBeesWax.block.getDefaultState();
		private static final IBlockState FLUID = BlockHoneyFluid.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:beehive")),};
