...
public class BiomeUnderblanketHive extends ElementsTmsModMod.ModElement {
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Underblanket Hive").setRainfall(0.5F).setBaseHeight(0.1F).setWaterColor(-14072051)
					.setHeightVariation(0.2F).setTemperature(0.5F));
			setRegistryName("underblanket_hive");
