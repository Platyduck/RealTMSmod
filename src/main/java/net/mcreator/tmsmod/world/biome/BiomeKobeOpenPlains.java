...
import net.mcreator.tmsmod.entity.EntityGrape;
import net.mcreator.tmsmod.ElementsTmsModMod;

import java.util.Random;

@ElementsTmsModMod.ModElement.Tag
public class BiomeKobeOpenPlains extends ElementsTmsModMod.ModElement {
	@GameRegistry.ObjectHolder("tms_mod:kobe_open_plains")
	public static final BiomeGenCustom biome = null;
	public BiomeKobeOpenPlains(ElementsTmsModMod instance) {
		super(instance, 1492);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Kobe Open Plains").setRainfall(0.5F).setBaseHeight(0.1F).setWaterColor(-16763905).setHeightVariation(0F)
					.setTemperature(0.5F));
			setRegistryName("kobe_open_plains");
			...
			this.spawnableCreatureList.add(new SpawnListEntry(EntityGrape.EntityCustom.class, 10, 1, 4));
		}
