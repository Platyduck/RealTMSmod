...
import net.mcreator.tmsmod.item.ItemKawp;
import net.mcreator.tmsmod.block.BlockKawpstone;
import net.mcreator.tmsmod.block.BlockAquamarinePlasticBricks;
...
public class WorldKawp extends ElementsTmsModMod.ModElement {
	public static int DIMID = 21;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("tms_mod:kawp_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemKawp().setUnlocalizedName("kawp").setRegistryName("kawp"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension kawp is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("kawp", "_kawp", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemKawp.block, 0, new ModelResourceLocation("tms_mod:kawp", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0, 0.866666666667, 1);
		}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag
											? BlockAquamarinePlasticBricks.block.getDefaultState().getBlock().getDefaultState()
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockAquamarinePlasticBricks.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("kawp_portal");
			setRegistryName("kawp_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down())
							.getBlock() != BlockAquamarinePlasticBricks.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockAquamarinePlasticBricks.block.getDefaultState().getBlock() ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockAquamarinePlasticBricks.block.getDefaultState().getBlock()) {
								break label56;
							}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockKawpstone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockKawpstone.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:enchanted_kawp_fields")),};
