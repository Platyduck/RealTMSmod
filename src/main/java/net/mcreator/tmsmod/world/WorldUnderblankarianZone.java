...
public class WorldUnderblankarianZone extends ElementsTmsModMod.ModElement {
	public static int DIMID = 16;
	public static final boolean NETHER_TYPE = true;
	@GameRegistry.ObjectHolder("tms_mod:underblankarian_zone_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemUnderblankarianZone().setUnlocalizedName("underblankarian_zone").setRegistryName("underblankarian_zone"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension underblankarian_zone is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("underblankarian_zone", "_underblankarian_zone", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemUnderblankarianZone.block, 0,
				new ModelResourceLocation("tms_mod:underblankarian_zone", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.321568627451, 0.666666666667, 0.270588235294);
		}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("underblankarian_zone_portal");
			setRegistryName("underblankarian_zone_portal");
			setLightLevel(0F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockMoss.block.getDefaultState();
		private static final IBlockState STONE2 = BlockMoss.block.getDefaultState();
		private static final IBlockState STONE3 = BlockMoss.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:mossy_hollows")),};
