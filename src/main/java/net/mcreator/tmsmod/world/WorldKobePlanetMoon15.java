...
import net.mcreator.tmsmod.item.ItemKobePlanetMoon15;
import net.mcreator.tmsmod.block.BlockPlasticStone;
...
public class WorldKobePlanetMoon15 extends ElementsTmsModMod.ModElement {
	public static int DIMID = 14;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("tms_mod:kobe_planet_moon_15_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldKobePlanetMoon15(ElementsTmsModMod instance) {
		super(instance, 231);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemKobePlanetMoon15().setUnlocalizedName("kobe_planet_moon_15").setRegistryName("kobe_planet_moon_15"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension kobe_planet_moon_15 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("kobe_planet_moon_15", "_kobe_planet_moon_15", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemKobePlanetMoon15.block, 0,
				new ModelResourceLocation("tms_mod:kobe_planet_moon_15", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0, 0.501960784314, 1);
		}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.EMERALD_BLOCK.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("kobe_planet_moon_15_portal");
			setRegistryName("kobe_planet_moon_15_portal");
			setLightLevel(0F);
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.SLIME, px, py, pz, vx, vy, vz);
			}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.EMERALD_BLOCK.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.EMERALD_BLOCK.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.EMERALD_BLOCK
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockPlasticStone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockPlasticStone.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:joshian_tunnel_park")),
				Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:plastic_taiga")),
				Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:plastic_birch_forest")),};
