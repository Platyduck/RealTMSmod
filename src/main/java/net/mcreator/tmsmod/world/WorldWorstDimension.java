...
import net.mcreator.tmsmod.item.ItemWorstDimension;
...
public class WorldWorstDimension extends ElementsTmsModMod.ModElement {
	public static int DIMID = 8;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("tms_mod:worst_dimension_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemWorstDimension().setUnlocalizedName("worst_dimension").setRegistryName("worst_dimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension worst_dimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("worst_dimension", "_worst_dimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemWorstDimension.block, 0, new ModelResourceLocation("tms_mod:worst_dimension", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.SOUL_SAND.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("worst_dimension_portal");
			setRegistryName("worst_dimension_portal");
			setLightLevel(0F);
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.NOTE, px, py, pz, vx, vy, vz);
			}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.SOUL_SAND.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.SOUL_SAND.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.SOUL_SAND
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockMoonStone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockMoonStone.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:distant_moon")),};
