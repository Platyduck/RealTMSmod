...
import net.mcreator.tmsmod.item.ItemSnurbum4;
...
public class WorldSnurbum4 extends ElementsTmsModMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("tms_mod:snurbum_4_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldSnurbum4(ElementsTmsModMod instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemSnurbum4().setUnlocalizedName("snurbum_4").setRegistryName("snurbum_4"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension snurbum_4 is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("snurbum_4", "_snurbum_4", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemSnurbum4.block, 0, new ModelResourceLocation("tms_mod:snurbum_4", "inventory"));
	}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.MOSSY_COBBLESTONE.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("snurbum_4_portal");
			setRegistryName("snurbum_4_portal");
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.MOSSY_COBBLESTONE.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.MOSSY_COBBLESTONE.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.MOSSY_COBBLESTONE
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockLimestone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockLimestone.block.getDefaultState();
