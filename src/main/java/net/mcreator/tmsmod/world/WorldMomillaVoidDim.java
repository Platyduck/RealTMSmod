...
import net.mcreator.tmsmod.item.ItemMomillaVoidDim;
import net.mcreator.tmsmod.block.BlockMomillaLog;
import net.mcreator.tmsmod.block.BlockMainframe;
import net.mcreator.tmsmod.block.BlockGlitchLeaf;
...
public class WorldMomillaVoidDim extends ElementsTmsModMod.ModElement {
	public static int DIMID = 15;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("tms_mod:momilla_void_dim_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemMomillaVoidDim().setUnlocalizedName("momilla_void_dim").setRegistryName("momilla_void_dim"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension momilla_void_dim is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("momilla_void_dim", "_momilla_void_dim", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemMomillaVoidDim.block, 0, new ModelResourceLocation("tms_mod:momilla_void_dim", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("momilla_void_dim_portal");
			setRegistryName("momilla_void_dim_portal");
			setLightLevel(1F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockGlitchLeaf.block.getDefaultState();
		private static final IBlockState STONE2 = BlockGlitchLeaf.block.getDefaultState();
		private static final IBlockState FLUID = BlockMomillaLog.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:momilla_void")),};
