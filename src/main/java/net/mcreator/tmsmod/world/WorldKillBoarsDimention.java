...
import net.mcreator.tmsmod.item.ItemKillBoarsDimention;
import net.mcreator.tmsmod.block.BlockMainframe;
...
public class WorldKillBoarsDimention extends ElementsTmsModMod.ModElement {
	public static int DIMID = 5;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("tms_mod:kill_boars_dimention_portal")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemKillBoarsDimention().setUnlocalizedName("kill_boars_dimention").setRegistryName("kill_boars_dimention"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension kill_boars_dimention is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("kill_boars_dimention", "_kill_boars_dimention", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemKillBoarsDimention.block, 0,
				new ModelResourceLocation("tms_mod:kill_boars_dimention", "inventory"));
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? BlockMainframe.block.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockMainframe.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("kill_boars_dimention_portal");
			setRegistryName("kill_boars_dimention_portal");
			setLightLevel(0F);
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.VILLAGER_ANGRY, px, py, pz, vx, vy, vz);
			}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockMainframe.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockMainframe.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockMainframe.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != BlockMainframe.block
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:snurbum_highlands")),
				Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:rift_biome")),
				Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:squinkel_woodlands")), Biome.REGISTRY.getObject(new ResourceLocation("ocean")),
				Biome.REGISTRY.getObject(new ResourceLocation("plains")), Biome.REGISTRY.getObject(new ResourceLocation("extreme_hills")),
				Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:rotlands")),
				Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:crag_peaks")),
				Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:pink_desert")),};
