...
public class ItemShinesaber extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("shinesaber").setRegistryName("shinesaber").setCreativeTab(TabTraditionalWeaponry.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("tms_mod:shinesaber", "inventory"));
	}
