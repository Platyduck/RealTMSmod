...
public class ItemRossminiumAxe extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("rossminium_axe").setRegistryName("rossminium_axe").setCreativeTab(TabTraditionalWeaponry.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("tms_mod:rossminium_axe", "inventory"));
	}
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("ROSSMINIUM_AXE", 1, 1000, 4f, 8f, 2), effective_items_set);
