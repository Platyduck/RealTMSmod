...
public class ItemJaconianPhaseblade extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("jaconian_phaseblade").setRegistryName("jaconian_phaseblade").setCreativeTab(TabTraditionalWeaponry.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("tms_mod:jaconian_phaseblade", "inventory"));
	}
