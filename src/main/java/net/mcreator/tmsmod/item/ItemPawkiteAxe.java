...
public class ItemPawkiteAxe extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("pawkite_axe").setRegistryName("pawkite_axe").setCreativeTab(CreativeTabs.TOOLS));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("tms_mod:pawkite_axe", "inventory"));
	}
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("PAWKITE_AXE", 4, 754, 10f, 16f, 31), effective_items_set);
