...
import net.mcreator.tmsmod.procedure.ProcedureGrillRecipes;
...
public class GuiGUIGrill extends ElementsTmsModMod.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tms_mod:textures/gui_grill.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("We do a little trolling...", 32, 7, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 42, this.guiTop + 52, 90, 20, "Troll le bird"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGrillRecipes.executeProcedure($_dependencies);
			}
		}
	}
