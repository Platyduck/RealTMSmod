...
public class GuiTrade1 extends ElementsTmsModMod.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tms_mod:textures/trade_1.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 97, this.guiTop + 55, 50, 20, "Trade"));
		}
