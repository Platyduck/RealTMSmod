...
public class GuiFabricator extends ElementsTmsModMod.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiFabricator(ElementsTmsModMod instance) {
		super(instance, 1503);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 34, 17) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 52, 17) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 70, 17) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 34, 35) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 52, 35) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 70, 35) {
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 34, 53) {
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 52, 53) {
			}));
			this.customSlots.put(8, this.addSlotToContainer(new Slot(internal, 8, 70, 53) {
			}));
			this.customSlots.put(9, this.addSlotToContainer(new Slot(internal, 9, 124, 35) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tms_mod:textures/fabricator.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 96, this.guiTop + 52, 70, 20, "Fabricate"));
		}
