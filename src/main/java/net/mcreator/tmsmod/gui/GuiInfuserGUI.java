...
import net.mcreator.tmsmod.procedure.ProcedureInfuserUpdateTick;
...
public class GuiInfuserGUI extends ElementsTmsModMod.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiInfuserGUI(ElementsTmsModMod instance) {
		super(instance, 1496);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 25, 35) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 61, 35) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 133, 35) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tms_mod:textures/infuser_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Infuser", 6, 7, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 114, this.guiTop + 7, 55, 20, "Infuse"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureInfuserUpdateTick.executeProcedure($_dependencies);
			}
		}
	}
