...
import net.mcreator.tmsmod.procedure.ProcedureDiskRecipes;
...
public class GuiDiskmakerGUI extends ElementsTmsModMod.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 52, 26) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 106, 26) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tms_mod:textures/diskmaker_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Disk Forgery", 6, 7, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 60, this.guiTop + 52, 50, 20, "Forge"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureDiskRecipes.executeProcedure($_dependencies);
			}
		}
	}
