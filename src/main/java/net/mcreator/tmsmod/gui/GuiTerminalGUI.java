...
import net.mcreator.tmsmod.procedure.ProcedureTerminalRecipes;
...
public class GuiTerminalGUI extends ElementsTmsModMod.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 43, 35) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 115, 35) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tms_mod:textures/terminal_gui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 51, this.guiTop + 7, 75, 20, "Alter Code"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureTerminalRecipes.executeProcedure($_dependencies);
			}
		}
	}
