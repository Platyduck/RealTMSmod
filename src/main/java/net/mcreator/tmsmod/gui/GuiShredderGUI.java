...
import net.mcreator.tmsmod.procedure.ProcedureShredderShred;
...
public class GuiShredderGUI extends ElementsTmsModMod.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiShredderGUI(ElementsTmsModMod instance) {
		super(instance, 1508);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 79, 35) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 133, 35) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tms_mod:textures/shredder_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("The Shredder", 6, 7, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 87, this.guiTop + 61, 50, 20, "Shred"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureShredderShred.executeProcedure($_dependencies);
			}
		}
	}
