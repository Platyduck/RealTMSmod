...
public class GuiCatstarelol extends ElementsTmsModMod.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("tms_mod:textures/catstarelol.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("his face", 67, 10, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 46, this.guiTop + 115, 85, 20, "sussy craige"));
		}
