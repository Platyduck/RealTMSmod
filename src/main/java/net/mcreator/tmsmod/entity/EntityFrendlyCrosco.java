...
public class EntityFrendlyCrosco extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "frendly_crosco"), ENTITYID)
						.name("frendly_crosco").tracker(64, 3, true).egg(-10000537, -12763843).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelcroscofrend(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/croscofrendly.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(6, new EntityAINearestAttackableTarget(this, EntityWither.class, false, false));
			...
			this.tasks.addTask(15, new EntityAITempt(this, 3, new ItemStack(ItemNyanGun.block, (int) (1)).getItem(), false));
		}
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("entity.llama.hurt"));
		}
