...
public class EntityUnderblankarian extends ElementsTmsModMod.ModElement {
	public static final int ENTITYID = 108;
	public static final int ENTITYID_RANGED = 109;
	public EntityUnderblankarian(ElementsTmsModMod instance) {
		super(instance, 708);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "underblankarian"), ENTITYID)
						.name("underblankarian").tracker(64, 3, true).egg(-13875420, -14337006).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:mossy_hollows")),};
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelUnderblankarian(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/texture-14.png.png");
				}
			};
		});
	}
