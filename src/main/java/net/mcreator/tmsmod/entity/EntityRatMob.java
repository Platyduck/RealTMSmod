...
import net.mcreator.tmsmod.procedure.ProcedureRatMobEntityDies;
import net.mcreator.tmsmod.item.ItemCheese;
...
public class EntityRatMob extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "rat_mob"), ENTITYID)
				.name("rat_mob").tracker(64, 3, true).egg(-6710887, -13108).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelRat(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/ratguy.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureRatMobEntityDies.executeProcedure($_dependencies);
			}
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(ItemCheese.block, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
	}
