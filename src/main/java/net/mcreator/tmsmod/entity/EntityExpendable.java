...
public class EntityExpendable extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "expendable"), ENTITYID)
				.name("expendable").tracker(64, 3, true).egg(-3355444, -10092544).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		DungeonHooks.addDungeonMob(new ResourceLocation("tms_mod:expendable"), 180);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/robloxgestguy.png");
				}
			};
	...
	public static class EntityCustom extends EntityCreature {
		public EntityCustom(World world) {
			...
			setNoAI(!true);
			this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(Items.WOODEN_HOE, (int) (1)));
		}
