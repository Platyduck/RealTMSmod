...
public class EntityTheHayden extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "the_hayden"), ENTITYID)
				.name("the_hayden").tracker(64, 3, true).egg(-26368, -13434880).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:happy_hell")),};
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelTheHayden(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/thehayden.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected void initEntityAI() {
			super.initEntityAI();
			this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityOween.EntityCustom.class, true, true));
		...
		protected Item getDropItem() {
			return new ItemStack(Blocks.RED_FLOWER, (int) (1), 5).getItem();
		}
