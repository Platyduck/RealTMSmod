...
import net.mcreator.tmsmod.item.ItemPlasticArrow;
...
public class EntityJoosh extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "joosh"), ENTITYID)
				.name("joosh").tracker(64, 3, true).egg(-13413326, -14672044).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:joshian_tunnel_park")),
				Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:underblanket_hive")),
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelRealBoi(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/joosh.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemPlasticArrow.block, (int) (1)).getItem();
		}
