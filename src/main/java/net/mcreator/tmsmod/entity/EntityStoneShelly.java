...
public class EntityStoneShelly extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "stone_shelly"), ENTITYID)
						.name("stone_shelly").tracker(64, 3, true).egg(-5131892, -8684677).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("stone_beach")),
				Biome.REGISTRY.getObject(new ResourceLocation("forest_hills")), Biome.REGISTRY.getObject(new ResourceLocation("beaches")),};
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelShelly(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/shelly2.png");
				}
			};
		});
	}
