...
public class EntityUnderblankarianLeader extends ElementsTmsModMod.ModElement {
	public static final int ENTITYID = 110;
	public static final int ENTITYID_RANGED = 111;
	public EntityUnderblankarianLeader(ElementsTmsModMod instance) {
		super(instance, 709);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "underblankarian_leader"), ENTITYID)
						.name("underblankarian_leader").tracker(64, 3, true).egg(-13875420, -14337006).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelUnderblankarian(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/texture-14.png_copy.png");
				}
			};
		});
	}
