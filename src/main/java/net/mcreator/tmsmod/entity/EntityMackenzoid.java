...
import net.mcreator.tmsmod.item.ItemAcursedTune;
...
public class EntityMackenzoid extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "mackenzoid"), ENTITYID)
				.name("mackenzoid").tracker(64, 3, true).egg(-26113, -65485).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:kenzone")),};
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelMackenzoid(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/mackenzoid.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected void initEntityAI() {
			super.initEntityAI();
			this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this, EntityDirtyBirdymob.EntityCustom.class, true, true));
		...
		protected Item getDropItem() {
			return new ItemStack(ItemAcursedTune.block, (int) (1)).getItem();
		}
