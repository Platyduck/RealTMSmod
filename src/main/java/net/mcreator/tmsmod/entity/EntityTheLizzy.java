...
import net.mcreator.tmsmod.procedure.ProcedureLizzyMeatDrop;
...
public class EntityTheLizzy extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "the_lizzy"), ENTITYID)
				.name("the_lizzy").tracker(64, 3, true).egg(-16711766, -11400180).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:distant_moon")),};
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelBombegranite(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/her.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureLizzyMeatDrop.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelBombegranite extends ModelBase {
		private final ModelRenderer bb_main;
		public ModelBombegranite() {
			textureWidth = 16;
			textureHeight = 16;
			bb_main = new ModelRenderer(this);
			bb_main.setRotationPoint(0.0F, 24.0F, 0.0F);
			bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, -2.0F, -4.0F, -2.0F, 4, 4, 4, 0.0F, false));
			bb_main.cubeList.add(new ModelBox(bb_main, 0, 8, -1.0F, -5.0F, 1.0F, 2, 2, 2, 0.0F, false));
			bb_main.cubeList.add(new ModelBox(bb_main, 5, 8, 0.0F, -4.0F, -3.0F, 2, 0, 1, 0.0F, false));
			bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, 0.0F, -4.0F, -3.0F, 2, 1, 0, 0.0F, false));
		}
