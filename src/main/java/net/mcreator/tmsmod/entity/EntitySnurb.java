...
import net.mcreator.tmsmod.procedure.ProcedureSnurbEntityDies;
...
public class EntitySnurb extends ElementsTmsModMod.ModElement {
	public static final int ENTITYID = 17;
	public static final int ENTITYID_RANGED = 18;
	public EntitySnurb(ElementsTmsModMod instance) {
		super(instance, 649);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "snurb"), ENTITYID)
				.name("snurb").tracker(64, 3, true).egg(-6684928, -16777063).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 20, 4, 8, EnumCreatureType.CREATURE, spawnBiomes);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelTheSnurb(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/thesnurb.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(2, new EntityAITempt(this, 1, new ItemStack(ItemLemon.block, (int) (1)).getItem(), false));
		...
		protected Item getDropItem() {
			return new ItemStack(ItemSnurbMeat.block, (int) (1)).getItem();
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("entity.llama.swag"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				ProcedureSnurbEntityDies.executeProcedure($_dependencies);
			}
		}
