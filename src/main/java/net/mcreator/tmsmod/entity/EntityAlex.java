...
import net.mcreator.tmsmod.item.ItemPizza;
...
public class EntityAlex extends ElementsTmsModMod.ModElement {
	public static final int ENTITYID = 45;
	public static final int ENTITYID_RANGED = 46;
	public EntityAlex(ElementsTmsModMod instance) {
		super(instance, 664);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "alex"), ENTITYID)
				.name("alex").tracker(64, 3, true).egg(-12401515, -14549023).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelRealBoi(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/alexreal.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemPizza.block, (int) (1)).getItem();
		}
