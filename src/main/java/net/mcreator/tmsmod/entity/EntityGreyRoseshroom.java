...
import net.mcreator.tmsmod.block.BlockWhiteRose;
import net.mcreator.tmsmod.ElementsTmsModMod;

@ElementsTmsModMod.ModElement.Tag
public class EntityGreyRoseshroom extends ElementsTmsModMod.ModElement {
	public static final int ENTITYID = 106;
	public static final int ENTITYID_RANGED = 107;
	public EntityGreyRoseshroom(ElementsTmsModMod instance) {
		super(instance, 666);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "grey_roseshroom"), ENTITYID)
						.name("grey_roseshroom").tracker(64, 3, true).egg(-8158333, -1118482).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("tms_mod:snurbum_highlands")),};
		EntityRegistry.addSpawn(EntityCustom.class, 5, 1, 1, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelmoobloom(), 1f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/greyroseshroom.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected Item getDropItem() {
			return new ItemStack(BlockWhiteRose.block, (int) (1)).getItem();
		}
