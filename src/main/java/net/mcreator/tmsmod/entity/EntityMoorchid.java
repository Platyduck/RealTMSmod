...
public class EntityMoorchid extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "moorchid"), ENTITYID)
				.name("moorchid").tracker(64, 3, true).egg(-10623745, -4857371).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelmoobloom(), 1f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/realmoorchid.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected Item getDropItem() {
			return new ItemStack(Blocks.RED_FLOWER, (int) (1), 1).getItem();
		}
