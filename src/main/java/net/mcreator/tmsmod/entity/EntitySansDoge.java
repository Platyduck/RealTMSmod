...
import net.mcreator.tmsmod.procedure.ProcedureSansdogespattack1;
import net.mcreator.tmsmod.procedure.ProcedureSansDogeOnEntityTickUpdate;
import net.mcreator.tmsmod.procedure.ProcedureSansDogeEntityDies;
...
public class EntitySansDoge extends ElementsTmsModMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("tms_mod", "sans_doge"), ENTITYID)
				.name("sans_doge").tracker(64, 3, true).egg(-16764007, -1).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("tms_mod:textures/2020_10_26_doge-con-ropa-de-sans-y-tajantemente-del-infinito-15597106-1.png.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.targetTasks.addTask(7, new EntityAINearestAttackableTarget(this, EntityExpendable.EntityCustom.class, true, true));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureSansdogespattack1.executeProcedure($_dependencies);
			}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("world", world);
				ProcedureSansDogeEntityDies.executeProcedure($_dependencies);
			}
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureSansDogeOnEntityTickUpdate.executeProcedure($_dependencies);
			}
		}
