...
import net.mcreator.tmsmod.procedure.ProcedureDyslexiaOnPotionActiveTick;
...
public class PotionDyslexia extends ElementsTmsModMod.ModElement {
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(true, -10092442);
			setRegistryName("dyslexia");
			setPotionName("effect.dyslexia");
			potionIcon = new ResourceLocation("tms_mod:textures/mob_effect/dyslexia.png");
		}
		...
		public void performEffect(EntityLivingBase entity, int amplifier) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureDyslexiaOnPotionActiveTick.executeProcedure($_dependencies);
			}
		}
